...
<style>
  ...
  .note { font-style: italic; font-size: 10pt; color: #555; background: #f0f0f0; padding: 10pt; border: 1px dashed #ccc; margin: 10pt 0; }
</style>
</head>
<body>
...
<div class="note">[ INSERT DASHBOARD SCREENSHOT HERE ]</div>
...
<div class="note">[ INSERT RESIDENT PROFILING SCREENSHOT HERE ]</div>
...
<div class="note">[ INSERT CERTIFICATIONS SCREENSHOT HERE ]</div>
...
<div class="note">[ INSERT ERD DIAGRAM IMAGE HERE ]</div>
<p><strong>Explanation:</strong><br/>
...
const outputPath = path.join(__dirname, 'Chapter3_4_Documentation.html');
fs.writeFileSync(outputPath, html, 'utf8');
console.log('✅ Done! File saved to:', outputPath);
console.log('📋 HOW TO CONVERT TO .docx:');
console.log('   1. Double-click: Chapter3_4_Documentation.html');
